...
const operation5 = '5. Scroll to see all.';
const noPictureToZoom = 'No picture to zoom! Click on the "back" arrow to Update your user details';
...
const imageDataField = 'imageData';
const imageFileNameField = 'imageFileName';
const userExistsField = 'userExists';
